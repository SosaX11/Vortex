...
-- Theme customized to match the image (Dark Red/Burgundy with Yellow accents)
local themes = {
    preset = {
        accent       = rgb(255, 215, 60),  -- Yellow/Gold for active toggles
        glow         = rgb(120, 30, 30),   
        
        background   = rgb(165, 55, 55),   -- Main reddish background (Right side)
        sidebar      = rgb(145, 40, 40),   -- Slightly darker for the left sidebar
        section      = rgb(175, 60, 60),   -- Elements/Dropdowns background
        element      = rgb(185, 70, 70),   -- Lighter for hover states
        
        outline      = rgb(200, 80, 80),   -- Borders
        text         = rgb(255, 255, 255), -- White text
        subtext      = rgb(240, 190, 190), -- Light pinkish/white for subtext
        
        tab_active   = rgb(185, 70, 70),   -- Highlighted tab
        tab_inactive = rgb(145, 40, 40),   -- Normal tab
    },
    utility = {}
}
...
function Vortex:Window(properties)
    local Cfg = {
        Title = properties.Title or properties.title or "Vray Family", 
